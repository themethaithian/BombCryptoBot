...
try:
    while True:
        time.sleep(7)
        while True:
            connectButton = pyautogui.locateCenterOnScreen('Image/Connect67.png', region = (0, 600, 750, 600), confidence = 0.7)
        ...
        mmButton = pyautogui.locateCenterOnScreen('Image/Meta67.png', region = (0, 600, 750, 600), confidence = 0.7)
        if mmButton == None:
            pyautogui.hotkey('ctrl', 'shift', 'r')
        ...
        while True:
            signButton = pyautogui.locateCenterOnScreen('Image/Sign67.png', region = (0, 600, 750, 600), confidence = 0.7)
            if signButton == None:
                pyautogui.hotkey('ctrl', 'shift', 'r')
                print('MetaMask Not Found -- Reloading')
                continue
        ...
        while True:
            ...
            selectHero = pyautogui.locateCenterOnScreen('Image/Hero67.png', region = (0, 600, 750, 600), confidence = 0.7)
            ...
            while isError == False:
                homeButton = pyautogui.locateCenterOnScreen('Image/Home67.png', region = (0, 600, 750, 600), confidence = 0.7)
                error = pyautogui.locateCenterOnScreen('Image/Error67.png', region = (0, 600, 750, 600), confidence = 0.7)
                if error != None:
                    pyautogui.click(error[0], error[1])
                    time.sleep(0.5)
            ...
            if isError == False:
                ...
                while True:
                    workButton = pyautogui.locateCenterOnScreen('Image/Work67.png', region = (0, 600, 750, 600), confidence = 0.95)
                    error = pyautogui.locateCenterOnScreen('Image/Error67.png', region = (0, 600, 750, 600), confidence = 0.7)
                    if error != None:
                        pyautogui.click(error[0], error[1])
                        time.sleep(0.5)
            ...
            while isError == False:
                closeHero = pyautogui.locateCenterOnScreen('Image/CloseHero67.png', region = (0, 600, 750, 600), confidence = 0.7)
                error = pyautogui.locateCenterOnScreen('Image/Error67.png', region = (0, 600, 750, 600), confidence = 0.7)
                if error != None:
                    pyautogui.click(error[0], error[1])
                    time.sleep(0.5)
            ...
            while isError == False:
                hunt = pyautogui.locateCenterOnScreen('Image/Hunt67.png', region = (0, 600, 750, 600), confidence = 0.7)
                error = pyautogui.locateCenterOnScreen('Image/Error67.png', region = (0, 600, 750, 600), confidence = 0.7)
                if error != None:
                    pyautogui.click(error[0], error[1])
                    time.sleep(0.5)
            ...
            while isError == False:
                ...
                if timeCheck >= 120:
                    newMap = pyautogui.locateCenterOnScreen('Image/NewMap67.png', region = (0, 600, 750, 600), confidence = 0.7)
                    error = pyautogui.locateCenterOnScreen('Image/Error67.png', region = (0, 600, 750, 600), confidence = 0.7)
                    if error != None:
                        pyautogui.click(error[0], error[1])
                        time.sleep(0.5)
