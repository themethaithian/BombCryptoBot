...
try:
    while True:
        ...
        f.close()
        while True:
            connectButton = pyautogui.locateCenterOnScreen('Image50/Connect50.png', region = (550, 450, 550, 600), confidence = 0.7)
            if connectButton == None:
                pyautogui.moveTo(840, 900)
                pyautogui.click(840, 900)
        ...
        mmButton = pyautogui.locateCenterOnScreen('Image50/Meta50.png', region = (550, 450, 550, 600), confidence = 0.7)
        if mmButton == None:
            pyautogui.moveTo(840, 900)
            pyautogui.click(840, 900)
            pyautogui.hotkey('ctrl', 'shift', 'r')
        ...
        while True:
            signButton = pyautogui.locateCenterOnScreen('Image50/Sign50.png', region = (550, 450, 550, 600), confidence = 0.7)
            if signButton == None:
                pyautogui.moveTo(840, 900)
                pyautogui.click(840, 900)
                pyautogui.hotkey('ctrl', 'shift', 'r')
        ...
        while True:
            ...
            selectHero = pyautogui.locateCenterOnScreen('Image50/Hero50.png', region = (550, 450, 550, 600), confidence = 0.7)
            error = pyautogui.locateCenterOnScreen('Image50/Error50.png', region = (550, 450, 550, 600), confidence = 0.7)
            ...
            f.close()
            while isError == False:
                homeButton = pyautogui.locateCenterOnScreen('Image50/Home50.png', region = (550, 450, 550, 600), confidence = 0.7)
                error = pyautogui.locateCenterOnScreen('Image50/Error50.png', region = (550, 450, 550, 600), confidence = 0.7)
            ...
            if isError == False:
                ...
                while True:
                    workButton = pyautogui.locateCenterOnScreen('Image50/Work50.png', region = (550, 450, 550, 600), confidence = 0.95)
                    error = pyautogui.locateCenterOnScreen('Image50/Error50.png', region = (550, 450, 550, 600), confidence = 0.7)
                    if error != None:
                        pyautogui.click(error[0], error[1])
                        time.sleep(0.5)
            ...
            while isError == False:
                closeHero = pyautogui.locateCenterOnScreen('Image50/CloseHero50.png', region = (550, 450, 550, 600), confidence = 0.7)
                error = pyautogui.locateCenterOnScreen('Image50/Error50.png', region = (550, 450, 550, 600), confidence = 0.7)
            ...
            while isError == False:
                hunt = pyautogui.locateCenterOnScreen('Image50/Hunt50.png', region = (550, 450, 550, 600), confidence = 0.7)
                error = pyautogui.locateCenterOnScreen('Image50/Error50.png', region = (550, 450, 550, 600), confidence = 0.7)
                if error != None:
                    pyautogui.click(error[0], error[1])
                    time.sleep(0.5)
            ...
            while isError == False:
                ...
                error = pyautogui.locateCenterOnScreen('Image50/Error50.png', region = (550, 450, 550, 600), confidence = 0.7)
                if timeCheck >= 120:
                    newMap = pyautogui.locateCenterOnScreen('Image50/NewMap50.png', region = (550, 450, 550, 600), confidence = 0.7)
                    if error != None:
                        pyautogui.click(error[0], error[1])
                        time.sleep(1)
                        pyautogui.hotkey('ctrl', 'shift', 'r')
                ...
                if timeResetCount >= 180:
                    if error != None:
                        ...
                        break
                    if backButton == None:
                        backButton = pyautogui.locateCenterOnScreen('Image50/Back50.png', region = (550, 450, 550, 600), confidence = 0.7)
